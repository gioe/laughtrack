...
## Web procedure (the runtime's browser automation tooling)
...
3. The the runtime's browser automation tooling saves screenshots to the project root (relative to repo root,
