...
```
Read file: <project_root>/AGENTS.md   # project purpose, architecture, and key conventions
```
...
If the pillars array is empty, note it — the assessment will rely on AGENTS.md and config alone.
...
1. `<directory>/AGENTS.md` — if present, read in full. This is the authoritative statement of the directory's intended purpose.
...
| What was it intended to do? | From its AGENTS.md, root AGENTS.md references, or tusk config |
...
- **What it was intended to do** — from its AGENTS.md, root AGENTS.md, or inferred from config
- **Its relationship to the project** — how it fits into the overall architecture described in AGENTS.md
- **Verdict** — one of:
