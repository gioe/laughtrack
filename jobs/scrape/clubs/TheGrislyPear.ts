...
const LINK = "div.col-xs-12.col-sm-6.col-sm-offset-1.upcoming-list-description > a";
const DATE_TIME = "ul > li.featured-event-date";
const COMEDIAN_NAME = "p.comedian-name";
const SHOW_NAME = "li.featured-event-title";
const PRICE = "div.event-ticket-type.col-sm-10.col-xs-9 > span.ticket-price.original";
