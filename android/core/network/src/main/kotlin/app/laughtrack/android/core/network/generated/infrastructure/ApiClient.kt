package app.laughtrack.android.core.network.generated.infrastructure

import app.laughtrack.android.core.network.generated.auth.HttpBearerAuth
...
import app.laughtrack.android.core.network.generated.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey: String = "app.laughtrack.android.core.network.generated.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://www.laugh-track.com/api/v1")
        }
    }
}
