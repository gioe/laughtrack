"""Event model for Barclays Center's official comedy category."""
...
@dataclass
class BarclaysCenterEvent(ShowConvertible):
    """A single event from Barclays Center's official comedy category."""
    ...
    def to_show(self, club: Club, enhanced: bool = True, url: Optional[str] = None):
        """Convert the event into a Show domain object."""
