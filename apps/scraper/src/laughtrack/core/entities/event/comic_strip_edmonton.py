"""Event model for The Comic Strip West Edmonton Mall."""
...
@dataclass
class ComicStripEdmontonEvent(ShowConvertible):
    """One Webflow event card from The Comic Strip Edmonton homepage."""
    ...
    def to_show(self, club: Club, enhanced: bool = True, url: Optional[str] = None) -> Optional[Show]:
        try:
            ...
            start_date = ShowFactoryUtils.parse_datetime_with_timezone_fallback(
                dt_str,
                club.timezone or "America/Edmonton",
            )
        except Exception:
            return None
        ...
        return ShowFactoryUtils.create_enhanced_show_base(
            name=self.title or "The Comic Strip Show",
            club=club,
            date=start_date,
