"""Data model for scraped page data from Improv Asylum."""
...
@dataclass
class ImprovAsylumPageData(EventListContainer[TixrEvent]):
    """
    Data model representing raw extracted data from Improv Asylum pages.
