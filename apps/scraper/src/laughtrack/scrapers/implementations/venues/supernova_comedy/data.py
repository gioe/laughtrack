"""Data model for scraped page data from SuperNova Comedy."""
...
@dataclass
class SuperNovaComedyPageData(EventListContainer[TixrEvent]):
    """
    Data model representing raw extracted data from SuperNova Comedy pages.
