...
def _make_show(name: str = "Tom Segura at Punch Line Philly") -> Show:
    ...
    return Show(
        ...
        show_page_url="https://www.bandsintown.com/e/12345678",
...
async def test_scrape_async_returns_empty_when_no_comedians_with_tour_ids():
    ...
    no comedians with BandsInTown IDs configured.
    """
    scraper = TourDatesScraper(_club())
...
async def test_scrape_async_aggregates_shows_across_multiple_comedians():
    ...
    comedian_rows = [
        _comedian_row(name="Tom Segura", uuid="a-1", bandsintown_id="tom-segura"),
        _comedian_row(name="Nate Bargatze", uuid="b-2", bandsintown_id="nate-bargatze"),
    ]
