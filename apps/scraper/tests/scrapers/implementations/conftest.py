"""
Shared test fixtures for api/, email/, json_ld/, and top-level scraper tests.
...
Uses sys.modules.setdefault() throughout — safe if venues/conftest.py or
test_rate_limiter.py registers the same stubs first; no-op if already present.
"""
