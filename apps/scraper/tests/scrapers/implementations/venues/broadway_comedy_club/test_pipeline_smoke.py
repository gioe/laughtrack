...
def _club() -> Club:
    _c = Club(id=99, name='Broadway Comedy Club', address='', website='https://broadwaycomedyclub.com', popularity=0, zip_code='', phone_number='', visible=True, timezone='America/New_York')
