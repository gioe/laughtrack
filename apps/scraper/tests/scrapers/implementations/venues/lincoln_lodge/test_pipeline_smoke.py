...
def _club() -> Club:
    _c = Club(id=999, name='The Lincoln Lodge', address='2040 N Milwaukee Ave', website='https://www.thelincolnlodge.com', popularity=0, zip_code='60647', phone_number='', visible=True, timezone='America/Chicago')
    _c.active_scraping_source = ScrapingSource(id=1, club_id=_c.id, platform='eventbrite', scraper_key='eventbrite', source_url=f'https://www.eventbrite.com/o/the-lincoln-lodge-{ORGANIZER_ID}', external_id=ORGANIZER_ID)
