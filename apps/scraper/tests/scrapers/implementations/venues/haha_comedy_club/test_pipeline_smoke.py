...
def _club() -> Club:
    _c = Club(id=163, name='HAHA Comedy Club', address='4712 Lankershim Blvd', website='https://www.hahacomedyclub.com', popularity=0, zip_code='91602', phone_number='', visible=True, timezone='America/Los_Angeles')
