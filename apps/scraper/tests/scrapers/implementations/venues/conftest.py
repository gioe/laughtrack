...
Uses sys.modules.setdefault() throughout — safe if test_rate_limiter.py or
any other file registers the same stubs first; no-op if already present.
"""
...
_SCRAPER_SRC = Path(__file__).parents[4] / "src"
