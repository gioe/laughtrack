...
def _club() -> Club:
    _c = Club(id=999, name='The Comedy Bar Chicago', address='162 E Superior St', website='https://comedybar.com', popularity=0, zip_code='60611', phone_number='', visible=True, timezone='America/Chicago')
    _c.active_scraping_source = ScrapingSource(id=1, club_id=_c.id, platform='eventbrite', scraper_key='eventbrite', source_url=f'https://www.eventbrite.com/o/the-comedy-bar-chicago-{ORGANIZER_ID}', external_id=ORGANIZER_ID)
