...
def _club() -> Club:
    _c = Club(id=999, name='Laugh Boston', address='425 Summer St', website='https://laughboston.com', popularity=0, zip_code='02210', phone_number='', visible=True, timezone='America/New_York')
    _c.active_scraping_source = ScrapingSource(id=1, club_id=_c.id, platform='custom', scraper_key='', source_url=GROUP_URL, external_id=None)
