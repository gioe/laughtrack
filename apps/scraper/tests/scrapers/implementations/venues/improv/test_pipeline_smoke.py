...
def _club() -> Club:
    _c = Club(id=1, name='Test Improv Club', address='123 Comedy St', website='https://improv.test', popularity=0, zip_code='00000', phone_number='000-0000', visible=True, timezone='America/New_York')
