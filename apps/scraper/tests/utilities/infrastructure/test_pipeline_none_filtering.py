...
Stubbing of laughtrack.utilities.infrastructure (to bypass its gioe_libs
import chain) is handled by this directory's conftest.py via the shared
gioe_stubs.register_stubs helper.
"""
