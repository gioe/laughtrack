-- Hide duplicate tour_dates stub for "Funny Bone Comedy Club Omaha" (club 2442).
--
-- Verification on 2026-05-14:
--   * Duplicate club 2442 has 0 shows and no tagged/subscription/email/
--     production-company dependent rows.
--   * Canonical club 1026 ("Omaha Funny Bone", Omaha NE, chain "Funny Bone")
--     is visible, active, and has an enabled Ticketmaster source (id 48,
--     ticketmaster_id 'Z7r9jZaelh') with 135 upcoming shows.
...
VALUES
    (2442, 'Funny Bone Comedy Club Omaha', 'Omaha', 'NE', 1450, 1026, 'Omaha Funny Bone', 48, 'Funny Bone Comedy Club Omaha');
...
SELECT
    ...
    '20260514230000: duplicate tour_dates stub ' || duplicate_id,
    TRUE
