-- Hide duplicate tour_dates stub for "The Well - Bakersfield" (club 2459).
--
-- Verification on 2026-05-15:
--   * Duplicate club 2459 has 0 shows and no tagged/subscription/email/
--     production-company dependent rows.
--   * Canonical club 77 ("The Well Comedy Club", Bakersfield CA, no chain)
--     is visible, active, and has an enabled SeatEngine source (id 182,
--     scraper_key 'seatengine_classic', seatengine_id 502) with 13 upcoming
--     shows through Dec 2026 (last scraped 2026-05-14).
--   * The duplicate display name is seeded as a club_alias on the canonical
...
VALUES
    (2459, 'The Well - Bakersfield', 'Bakersfield', 'CA', 1467, 77, 'The Well Comedy Club', 182, 'The Well - Bakersfield');
...
SELECT
    ...
    '20260515003500: duplicate tour_dates stub ' || duplicate_id,
    TRUE
