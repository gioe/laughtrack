...
export async function DELETE(
    ...
    try {
        ...
        const { podcastId: rawPodcastId } = await params;
        const podcastId = Number.parseInt(rawPodcastId, 10);
        ...
        await db.favoritePodcast.delete({
        ...
        console.error(
            "DELETE /api/v1/favorite-podcasts/[podcastId] error:",
            error,
        );
        return NextResponse.json(
            { error: "Failed to remove favorite podcast" },
