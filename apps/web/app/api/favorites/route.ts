    ...
    try {
        ...
        const comedians = favorites.map((favorite) => ({
            ...
            socialData: {
                ...
                instagramAccount: favorite.comedian.instagramAccount,
                instagramFollowers: favorite.comedian.instagramFollowers,
                tiktokAccount: favorite.comedian.tiktokAccount,
                tiktokFollowers: favorite.comedian.tiktokFollowers,
                youtubeAccount: favorite.comedian.youtubeAccount,
                youtubeFollowers: favorite.comedian.youtubeFollowers,
