            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="mb-10 font-dmSans text-[16px]">
                    ...
                    <p>
                        ...
                        of Laughtrack Digital, LLC and its licensors. The
                        Service is protected by copyright, trademark, and other
                ...
                <div className="mb-10 font-dmSans text-[16px]">
                    ...
                    <p>
                        Laughtrack Digital, LLC has no control over, and assumes
                        no responsibility for, the content, privacy policies, or
                        practices of any third-party web sites or services. You
                        further acknowledge and agree that Laughtrack Digital,
                ...
                <div className="mb-10 font-dmSans text-[16px]">
                    ...
                    <p>
                        ...
                        party on the Service; (iii) any content obtained from
                        the Service; and (iv) unauthorized access, use or
                        alteration of your transmissions or content, whether
                        based on warranty, contract, tort (including negligence)
                        or any other legal theory, whether or not we have been
                        informed of the possibility of such damage, and even if
                ...
                <div className="mb-10 font-dmSans text-[16px]">
                    ...
                    <p>
                        ...
                        and its licensors do not warrant that a) the Service
