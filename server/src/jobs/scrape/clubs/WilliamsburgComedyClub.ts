...
const DATE_TIME = "div.event-info-col > div.date-formatted > span.q-mr-sm.text-positive";
const SHOW_NAME = "div.event-info-title";
const PRICE = "#event-info-right-sticky > div.event-info-right-container > div > div > div";
