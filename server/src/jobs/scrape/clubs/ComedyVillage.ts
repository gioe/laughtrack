...
const ALL_LINKS = "div.tribe-events-c-small-cta.tribe-common-b3.tribe-events-calendar-list__event-cost > a";
const NEXT = "li.tribe-events-c-nav__list-item.tribe-events-c-nav__list-item--next > a";
const DATE_TIME = "div.tribe-events-schedule.tribe-clearfix > h2 > span.tribe-event-date-start";
