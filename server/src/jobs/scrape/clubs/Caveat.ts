...
import { delay } from "../../../common/util/promiseUtil.js";

const LINK = "a.MuiTypography-root.MuiTypography-body.MuiLink-root.MuiLink-underlineAlways.css-2p1ku6";
const MORE = "div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.css-15j76c0 > div.MuiBox-root.css-y3gv0i > button.MuiButton-root.MuiButton-text.MuiButton-textPrimary.MuiButton-sizeMedium.MuiButton-textSizeMedium.MuiButtonBase-root.css-t7zduo > span.MuiTouchRipple-root.css-w0pj6f";
const DATE_TIME = "#root > div > div.main.MuiBox-root.css-0 > div > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.MuiGrid-grid-md-8.css-efwuvd > div > div.MuiBox-root.css-1i8t0k4 > span";
const COMEDIAN_NAME = "div.MuiBox-root.css-svv1h6 > span.MuiTypography-root.MuiTypography-body.css-16ut9zt";
const SHOW_NAME = "#root > div > div.main.MuiBox-root.css-0 > div > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.MuiGrid-grid-md-8.css-efwuvd > div > div.MuiBox-root.css-10dy3fq > span";
