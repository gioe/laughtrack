...
import MiniComedianIcon, { MiniEntityIcon } from "../../icons/MiniEntityIcon";
...
const ShowInfoCard: React.FC<ShowInfoCardProps> = ({ show }) => {
    const [src, setSrc] = useState<string>(
        `/images/clubs/square/${show.clubName ?? ""}.png`,
    );
